        ...
        return flextype('twig')->render(
            ...
            [
                ...
                'links' =>  [
                    ...
                    'api_files' => [
                        'link' => flextype('router')->pathFor('admin.api_files.index'),
                ...
                'buttons' => [
                    'api_files_add' => [
                        'link' => flextype('router')->pathFor('admin.api_files.add'),
    ...
    public function addProcess(Request $request, Response $response) : Response
    {
        ...
        if (! Filesystem::has($api_token_file_path)) {
            ...
            if (Filesystem::write(
                ...
                flextype('flash')->addMessage('success', __('admin_message_files_api_token_created'));
            } else {
        ...
        if (isset($post_data['create-and-edit'])) {
            return $response->withRedirect(flextype('router')->pathFor('admin.api_files.edit') . '?token=' . $api_token);
        } else {
            return $response->withRedirect(flextype('router')->pathFor('admin.api_files.index'));
        }
    }
    ...
    public function editProcess(Request $request, Response $response) : Response
    {
        ...
        if (Filesystem::has($api_token_file_path)) {
            if (Filesystem::write(
                ...
                flextype('flash')->addMessage('success', __('admin_message_files_api_token_updated'));
            }
        } else {
