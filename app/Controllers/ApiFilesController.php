...
class ApiFilesController extends Container
{
    ...
    public function addProcess(Request $request, Response $response) : Response
    {
        ...
        if (! Filesystem::has($api_token_file_path)) {
            ...
            if (Filesystem::write(
                ...
                $this->flash->addMessage('success', __('admin_message_delivery_files_api_token_created'));
            } else {
                $this->flash->addMessage('error', __('admin_message_delivery_files_api_token_was_not_created1'));
            }
        } else {
            $this->flash->addMessage('error', __('admin_message_delivery_files_api_token_was_not_created2'));
        }
    ...
    public function editProcess(Request $request, Response $response) : Response
    {
        ...
        if (Filesystem::has($api_token_file_path)) {
            if (Filesystem::write(
                ...
                $this->flash->addMessage('success', __('admin_message_delivery_files_api_token_updated'));
            }
        } else {
            $this->flash->addMessage('error', __('admin_message_delivery_files_api_token_was_not_updated'));
        }
    ...
    public function deleteProcess(Request $request, Response $response) : Response
    {
        ...
        if (Filesystem::deleteDir($api_token_dir_path)) {
            $this->flash->addMessage('success', __('admin_message_delivery_files_api_token_deleted'));
        } else {
            $this->flash->addMessage('error', __('admin_message_delivery_files_api_token_was_not_deleted'));
        }
