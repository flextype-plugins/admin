        ...
        return flextype('twig')->render(
            ...
            [
                ...
                'links' =>  [
                    ...
                    'api_folders' => [
                        'link' => flextype('router')->pathFor('admin.api_folders.index'),
                ...
                'buttons' => [
                    'api_folders_add' => [
                        'link' => flextype('router')->pathFor('admin.api_folders.add'),
    ...
    public function addProcess(Request $request, Response $response) : Response
    {
        ...
        if (! Filesystem::has($api_token_file_path)) {
            ...
            if (Filesystem::write(
                ...
                flextype('flash')->addMessage('success', __('admin_message_folders_api_token_created'));
            } else {
        ...
        if (isset($post_data['create-and-edit'])) {
            return $response->withRedirect(flextype('router')->pathFor('admin.api_folders.edit') . '?token=' . $api_token);
        } else {
            return $response->withRedirect(flextype('router')->pathFor('admin.api_folders.index'));
        }
    }
        ...
        return flextype('twig')->render(
            ...
            [
                ...
                'links' =>  [
                    ...
                    'api_tokens_edit' => [
                        'link' => flextype('router')->pathFor('admin.api_folders.edit'),
    ...
    public function editProcess(Request $request, Response $response) : Response
    {
        ...
        if (Filesystem::has($api_token_file_path)) {
            if (Filesystem::write(
                ...
                flextype('flash')->addMessage('success', __('admin_message_folders_api_token_updated'));
            }
        } else {
            flextype('flash')->addMessage('error', __('admin_message_folders_api_token_was_not_updated'));
        }
