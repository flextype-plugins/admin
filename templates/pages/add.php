...
<form method="post">
    ...
    <a class="btn btn-lg btn-dark" href="<?php echo Flextype\Component\Http\Http::getBaseUrl(); ?>/admin/pages"><?php echo Flextype\I18n::find('admin_save', 'admin', Flextype\Config::get('site.locale')); ?></a>
</form>
