  ...
  <div class="col-4" style="margin: 0 auto;">
      <div class="dark-panel">
          <div class="dark-panel-header">
              <h3 class="h3"><?php echo I18n::find('admin_login', 'admin', Registry::get('site.locale')); ?></h3>
          </div>
          ...
          <div class="dark-panel-footer">
              <button class="btn btn-black btn-block" name="login" type="submit"><?php echo I18n::find('admin_login', 'admin', Registry::get('site.locale')); ?></button>
          </div>
      </div>
     </div>
</div>
