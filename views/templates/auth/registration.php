  ...
  <div class="col-4" style="margin: 0 auto;">
      <div class="dark-panel">
          <div class="dark-panel-header">
              <h3 class="h3"><?php echo I18n::find('admin_users_create_new', Registry::get('system.locale')); ?></h3>
          </div>
          <div class="dark-panel-body">
              ...
              <label for="inputUsername"><?php echo I18n::find('admin_email', Registry::get('system.locale')); ?></label>
          ...
          <div class="dark-panel-footer">
              <button class="btn btn-black btn-block" name="registration" type="submit"><?php echo I18n::find('admin_users_create', Registry::get('system.locale')); ?></button>
          </div>
      </div>
    </div>
</div>
