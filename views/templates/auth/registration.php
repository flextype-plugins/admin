    ...
    <div class="row">
        <div class="col-4 float-center">
            ...
            <div class="form-group">
                <?php
                    echo (
                        Form::label('email', I18n::find('admin_email', Registry::get('system.locale')), ['for' => 'inputEmail']).
            ...
            <div class="form-group">
                <?php echo Form::submit('registration', I18n::find('admin_users_create', Registry::get('system.locale')), ['class' => 'btn btn-black']); ?>
            </div>
        </div>
    </div>
